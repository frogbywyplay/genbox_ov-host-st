...
eblit-src_unpack-post() {
	# apply STLinux2.3 patches
		if [[ $(tc-arch) == "sh" ]]; then
		cd ${S}
		echo "Apply ST Patches"
		epatch ${FILESDIR}/st_patches/${RELEASE_VER}/glibc-2.6-nscd_init.patch
		epatch ${FILESDIR}/st_patches/${RELEASE_VER}/glibc-2.6-tzconfig.patch
		# FIXME: check if this patch have been apply upstream
		#epatch ${FILESDIR}/st_patches/${RELEASE_VER}/glibc-2.3.6-nptl-config.patch
		epatch ${FILESDIR}/st_patches/${RELEASE_VER}/glibc-2.6.1-alloca_fix.patch
		epatch ${FILESDIR}/st_patches/${RELEASE_VER}/glibc-2.5-ustat.patch
		epatch ${FILESDIR}/st_patches/${RELEASE_VER}/glibc-2.5-memcpy.patch
		epatch ${FILESDIR}/st_patches/${RELEASE_VER}/glibc-2.5-shsyscall2.patch
		epatch ${FILESDIR}/st_patches/${RELEASE_VER}/glibc-2.5-sh-atomic-fixes.patch
		epatch ${FILESDIR}/st_patches/${RELEASE_VER}/glibc-2.5-mutex.patch
		epatch ${FILESDIR}/st_patches/${RELEASE_VER}/glibc-2.5-clone.patch
		epatch ${FILESDIR}/st_patches/${RELEASE_VER}/glibc-2.5-fegetexceptflag.patch
		epatch ${FILESDIR}/st_patches/${RELEASE_VER}/glibc-2.5-sh-staticfix.patch
		epatch ${FILESDIR}/st_patches/${RELEASE_VER}/glibc-2.5-sh-bsd_setjmp-fix.patch
		epatch ${FILESDIR}/st_patches/${RELEASE_VER}/glibc-2.6.1-stm-ieee-fix.patch
	else
		cp ${FILESDIR}/config.wybox-x86 ${WORKDIR}
	fi
